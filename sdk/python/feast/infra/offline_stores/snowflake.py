...
class SnowflakeRetrievalJob(RetrievalJob):
    ...
    def to_remote_storage(self) -> List[str]:
        ...
        query = f"""
            COPY INTO '{self.export_path}/{table}' FROM "{self.config.offline_store.snowflake_connection.database}"."{self.config.offline_store.snowflake_connection.schema_}"."{table}"\n
